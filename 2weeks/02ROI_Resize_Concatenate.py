...
#         if y > 200 and y < 300:# ******* 1) y 가 300 미만일 때 ***********:
#             ROI[y][x] = img[y][x]
#         else:
#             ROI[y][x] = 0
#
...
# resize2 = cv.resize(img, (0, 0), fx=0.5, fy=0.6) #2) 가로 0.5배, 세로 0.6배로 리사이즈 하기 hint: dsize (0, 0)으로 초기화 해야함)************
#
#
# cv.imshow("origin", img)
